...
from lib.run_commnad import command
...
if __name__ == '__main__':
    host = "r-hahaha.redis.rds.aliyuncs.com"
    port = 6379
    password = "hahaha"
    node_num = 5
    db = 0
    ro = Redis_operator(host=host, port=port, password=password)
    pprint(ro.get_node_hot_key_outflow(node_num=node_num, db=db))
